                ...
                <div class="business-content-inner">
                    ...
                    <div class="business-info">
                        ...
                        <ul class="business-features">
                            <li>Gestão de pedidos em mesas, balcão e delivery</li>
                            <li>Envio automático de pedidos para a cozinha</li>
                            <li>Controle de cardápio e preços</li>
                            <li>Divisão de conta e múltiplas formas de pagamento</li>
                            <li>Controle de estoque de insumos</li>
                        </ul>
                        <div class="business-buttons">
                            <a href="/solutions" class="btn-business-primary">Conheça as soluções →</a>
                            <a href="/contact" class="btn-business-secondary">Falar com especialista</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="business-content" id="business-varejo">
                <div class="business-content-inner">
                    ...
                    <div class="business-info">
                        ...
                        <ul class="business-features">
                            <li>Modelos de autoatendimento e mini mercados</li>
                            <li>Cadastro de clientes com limite de crédito - fiado</li>
                            <li>Gestão de promoções e descontos</li>
                            <li>Histórico de vendas e comportamento de compra</li>
                            <li>Relatórios de vendas por loja, produto e período</li>
                        </ul>
                        <div class="business-buttons">
                            <a href="/solutions" class="btn-business-primary">Conheça as soluções →</a>
                            <a href="/contact" class="btn-business-secondary">Falar com especialista</a>
            ...
            <div class="business-content" id="business-eventos">
                <div class="business-content-inner">
                    ...
                    <div class="business-info">
                        ...
                        <ul class="business-features">
                            <li>Pontos de atendimento simultâneos</li>
                            <li>Operação adequada para ambientes com internet instável</li>
                            <li>Criação ágil de cardápios para cada evento</li>
                            <li>Conferência rápida ao final do evento ou do dia</li>
                        </ul>
                        <div class="business-buttons">
                            <a href="/solutions" class="btn-business-primary">Conheça as soluções →</a>
                            <a href="/contact" class="btn-business-secondary">Falar com especialista</a>
            ...
            <div class="business-content" id="business-servicos">
                <div class="business-content-inner">
                    ...
                    <div class="business-info">
                        ...
                        <ul class="business-features">
                            <li>Padronização de produtos, preços e regras comerciais</li>
                            <li>Gestão centralizada com visão por unidade</li>
                            <li>Relatórios consolidados de vendas</li>
                            <li>Controle de estoque por loja</li>
                            <li>Configuração de perfis e permissões por franquia</li>
                            <li>Facilidade na abertura de novas unidades</li>
                        </ul>
                        <div class="business-buttons">
                            <a href="/solutions" class="btn-business-primary">Conheça as soluções →</a>
                            <a href="/contact" class="btn-business-secondary">Falar com especialista</a>
