    ...
    <div class="content-form">
      ...
      <form>
        ...
        <div class="content-input">
          ...
          <input placeholder="Tipo de operação">
        </div>
        <div class="content-input">
          <p>Faturamento atual</p>
          <input placeholder="Faturamento atual">
        </div>
        <div class="content-input">
          <p>Já utiliza sistema de gestão?</p>
          <input placeholder="Já utiliza sistema de gestão?">
        </div>
        <div class="content-input">
          <p>Qual é seu principal desafio?</p>
          <input placeholder="Qual é seu principal desafio?">
        </div>
      </form>
