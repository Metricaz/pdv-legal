...
<main>
    ...
    <section class="timeline-section">
        <div class="container"> 
            ...
            <div class="carousel-track" id="carouselTrack">
                ...
                <p>Nosso plano é usar a inteligência digital para automatizar tarefas chatas. Queremos que o lojista tenha menos burocracia e muito mais tempo para vender.</p>
                </div>

                <div class="timeline-item">
                <div class="badge badge-solid">2024</div>
                <h3>Grandes<br>Parcerias</h3>
                <p>Nossa tecnologia ganhou confiança nacional. Fechamos parcerias com grandes marcas de hardware e adquirentes, levando o PDV Legal para milhares de novos balcões.</p>
                </div>

                <div class="timeline-item">
                <div class="badge badge-solid">2023</div>
                <h3>Lado a lado com o<br>Cliente</h3>
                <p>Reforçamos nosso suporte humanizado. Acreditamos que tecnologia de ponta precisa de um atendimento que fala a língua do povo e resolve os problemas de verdade.</p>
                </div>
    ...
    <section class="about-events">
        <div class="content-img-events">
            ...
            <img class="img-events-desktop" src="<?php echo get_template_directory_uri(); ?>/assets/images/about/events.png" alt="Eventos da empresa" />
            <img class="img-events-mobile" src="<?php echo get_template_directory_uri(); ?>/assets/images/about/events-mobile.png" alt="Eventos da empresa" />
        </div>
    ...
    <div class="accordion-about-container">
       ...
       <?php
        ...
        ?>
        <p class="text-more-faq">Não encontrou o que buscava aqui? Acesse nossa base de conhecimento com<br/>artigos, tutoriais e soluções.</p>
